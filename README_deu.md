...
Dieses Projekt ist Teil eines größeren Robotik-Ökosystems desselben Autors (JuanenRac / Electro Hobby 3D), das aus vielen Projekten rund um Firmware, Steuerungs-Apps, KI-Knoten und industrielle Integration besteht. Gut zu wissen, denn eine Anfrage könnte sich tatsächlich auf eines davon beziehen statt auf dieses Repository.
