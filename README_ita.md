...
**Versione:** 0.1.0 · **Autore:** JuanenRac (Electro Hobby 3D) &lt;electrohobby3d@gmail.com&gt;
...
Questo progetto fa parte di un ecosistema robotico più ampio dello stesso autore (JuanenRac / Electro Hobby 3D), composto da molti progetti che spaziano tra firmware, app di controllo, nodi IA e integrazione industriale. Vale la pena conoscerlo, poiché una richiesta potrebbe in realtà riguardare uno di questi invece di questo repository.

### Direttamente correlati a questo progetto

- **[HYDRA-UMC-TOOL-CLI](https://github.com/JuanenRac/HYDRA-UMC-TOOL-CLI)** — esegue audit su scala di flotta (il comando `audit`), oltre l'ambito a singola scheda coperto da questo tester.
- **[URTC-VISION-TOOL](https://github.com/JuanenRac/URTC-VISION-TOOL)** — completa la diagnostica live del bus CAN di questo progetto con i propri controlli visivi di qualità (QA) sulla testa utensile.
