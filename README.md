...
- **[HYDRA-UMC-DSI](https://github.com/JuanenRac/HYDRA-UMC-DSI)** — planned: a native touch UI for HYDRA-UMC's own 5"/7" DSI touchscreen (1280×720, same resolution at both sizes) on the Compute Module 5, controlling this same server directly from the board. Not started yet.
...
- URTC Tester *(this repository)* — desktop live CAN-bus diagnostic tool for URTC boards, one panel per tool profile (Windows/Linux).
